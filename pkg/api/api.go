...
// GetBatches retrieves a list of batches for a specific date, hour and request, and returns an error if any.
...
// GetBatch retrieves a single batch for a specific date, hour and ID, and returns an error if any.
...
// HeadBatch retrieves only the headers of a single batch for a specific date, hour and ID, and returns an error if any.
...
// ReadBatch reads the contents of a single batch for a specific date, hour and ID, and invokes the specified callback function for each chunk read.
...
// DownloadBatch downloads the contents of a single batch for a specific date, hour and ID, and writes the data to the specified WriteSeeker.
